...
> **PENDIENTE — verificación.** Antes de la entrega, revisar los tres sitios y confirmar que las
> cifras y módulos citados siguen vigentes, anotando la fecha de consulta. Los precios no están
> publicados en ninguno de los tres: si se consigue una cotización referencial, citar su origen;
> si no, dejar constancia de que el precio no es público y de que la comercialización es por
> cotización. **No estimar precios.**
